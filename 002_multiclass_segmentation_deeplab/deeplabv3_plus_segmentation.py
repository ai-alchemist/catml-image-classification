...
"""
Link to dataset: https://drive.google.com/uc?id=1B9A9UCJYMwTL4oBEo4RZfbMZMaZhKJaz&confirm=t
"""
...
parser.add_argument('dataset_path',
                    help='Path to root of dataset directory.')
...
parser.add_argument('--image_size', type=int, default=512,
                    help='Vertical and horizontal resolution of image in pixels for training.')
...
DATA_DIR = os.path.join(DATASET_ROOT_DIR, "Training")
...
colormap = loadmat(
    str(DATASET_ROOT_DIR + "/human_colormap.mat")
)["colormap"]
